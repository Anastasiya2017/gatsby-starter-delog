  ...
  return (
    <Layout>
      ...
      <div style={{textAlign: "center", padding:"5vh 0", lineHeight: "1.5"}}>
        ...
        <h1>Упс... Страница, которую вы искали - не существует 😭</h1><p> Зато можно написать мне лично в <a
                    href="https://t.me/girlwithbun">Telegram</a> и получить ответ быстрее.</p><p> Или поищите нужную информацию на <Link to="/">главной странице</Link>.</p>
      </div>
    </Layout>
  )
}
